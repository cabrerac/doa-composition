...
def callback(ch, method, properties, body):
    ...
    time.sleep(ms)
    message_dict = {
        'req_id': req_id, 'user_topic': user_topic, 'expected_output': expected_output, 'desc': 'message from service_75', 'next_topic': 'service._OUTPUT_SERVICE_75',
        'parameters': [
            {'name': 'p', 'value': 'Response from service_75'}
        ]
    }
