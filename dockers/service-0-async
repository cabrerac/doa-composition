...
COPY microservices/service_0_async.py .
...
COPY datasets/descriptions/100-100000-services/services/service_0.json ./description/

# Specify the command to run on container start
CMD ["python", "-u", "./service_0_async.py"]
