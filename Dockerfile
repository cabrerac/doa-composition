...
COPY microservices/service_21_async.py .
...
COPY datasets/descriptions/100-100000-services/services/service_21.json ./description/

# Specify the command to run on container start
CMD ["python", "-u", "./service_21_async.py"]
