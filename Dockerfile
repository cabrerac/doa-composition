...
COPY microservices/service_30_async.py .
...
COPY datasets/descriptions/100-100000-services/services/service_30.json ./description/

# Specify the command to run on container start
CMD ["python", "-u", "./service_30_async.py"]
